...
import com.blobcity.Constant.Companion.assetAdvanced434Path
import com.blobcity.Constant.Companion.assetAdvanced435Path
import com.blobcity.Constant.Companion.assetAdvanced439Path
import com.blobcity.Constant.Companion.assetAdvanced440Path
import com.blobcity.Constant.Companion.assetAdvanced446Path
import com.blobcity.Constant.Companion.assetAdvanced447Path
import com.blobcity.Constant.Companion.assetAdvanced451Path
import com.blobcity.Constant.Companion.assetAdvanced452Path
import com.blobcity.Constant.Companion.assetAdvanced458Path
import com.blobcity.Constant.Companion.assetAdvanced459Path
import com.blobcity.Constant.Companion.assetAdvanced463Path
import com.blobcity.Constant.Companion.assetAdvanced464Path
import com.blobcity.Constant.Companion.assetAdvanced470Path
import com.blobcity.Constant.Companion.assetAdvanced471Path
import com.blobcity.Constant.Companion.assetAdvanced475Path
import com.blobcity.Constant.Companion.assetAdvanced476Path
import com.blobcity.Constant.Companion.assetAdvanced482Path
import com.blobcity.Constant.Companion.assetAdvanced483Path
import com.blobcity.Constant.Companion.assetAdvanced487Path
import com.blobcity.Constant.Companion.assetAdvanced488Path
import com.blobcity.Constant.Companion.assetAdvanced494Path
...
import com.blobcity.Constant.Companion.assetBasic430Path
import com.blobcity.Constant.Companion.assetBasic431Path
import com.blobcity.Constant.Companion.assetBasic432Path
import com.blobcity.Constant.Companion.assetBasic433Path
import com.blobcity.Constant.Companion.assetBasic442Path
import com.blobcity.Constant.Companion.assetBasic443Path
import com.blobcity.Constant.Companion.assetBasic444Path
import com.blobcity.Constant.Companion.assetBasic445Path
import com.blobcity.Constant.Companion.assetBasic454Path
import com.blobcity.Constant.Companion.assetBasic455Path
import com.blobcity.Constant.Companion.assetBasic456Path
import com.blobcity.Constant.Companion.assetBasic457Path
import com.blobcity.Constant.Companion.assetBasic466Path
import com.blobcity.Constant.Companion.assetBasic467Path
import com.blobcity.Constant.Companion.assetBasic468Path
import com.blobcity.Constant.Companion.assetBasic469Path
import com.blobcity.Constant.Companion.assetBasic478Path
import com.blobcity.Constant.Companion.assetBasic479Path
import com.blobcity.Constant.Companion.assetBasic480Path
import com.blobcity.Constant.Companion.assetBasic481Path
import com.blobcity.Constant.Companion.assetBasic490Path
...
import com.blobcity.Constant.Companion.assetIntermediate436Path
import com.blobcity.Constant.Companion.assetIntermediate437Path
import com.blobcity.Constant.Companion.assetIntermediate438Path
import com.blobcity.Constant.Companion.assetIntermediate441Path
import com.blobcity.Constant.Companion.assetIntermediate448Path
import com.blobcity.Constant.Companion.assetIntermediate449Path
import com.blobcity.Constant.Companion.assetIntermediate450Path
import com.blobcity.Constant.Companion.assetIntermediate453Path
import com.blobcity.Constant.Companion.assetIntermediate460Path
import com.blobcity.Constant.Companion.assetIntermediate461Path
import com.blobcity.Constant.Companion.assetIntermediate462Path
import com.blobcity.Constant.Companion.assetIntermediate465Path
import com.blobcity.Constant.Companion.assetIntermediate472Path
import com.blobcity.Constant.Companion.assetIntermediate473Path
import com.blobcity.Constant.Companion.assetIntermediate474Path
import com.blobcity.Constant.Companion.assetIntermediate477Path
import com.blobcity.Constant.Companion.assetIntermediate484Path
import com.blobcity.Constant.Companion.assetIntermediate485Path
import com.blobcity.Constant.Companion.assetIntermediate486Path
import com.blobcity.Constant.Companion.assetIntermediate489Path
import com.blobcity.Constant.Companion.assetIntermediate496Path
...
import com.blobcity.Constant.Companion.localAdvanced434Path
import com.blobcity.Constant.Companion.localAdvanced435Path
import com.blobcity.Constant.Companion.localAdvanced439Path
import com.blobcity.Constant.Companion.localAdvanced440Path
import com.blobcity.Constant.Companion.localAdvanced446Path
import com.blobcity.Constant.Companion.localAdvanced447Path
import com.blobcity.Constant.Companion.localAdvanced451Path
import com.blobcity.Constant.Companion.localAdvanced452Path
import com.blobcity.Constant.Companion.localAdvanced458Path
import com.blobcity.Constant.Companion.localAdvanced459Path
import com.blobcity.Constant.Companion.localAdvanced463Path
import com.blobcity.Constant.Companion.localAdvanced464Path
import com.blobcity.Constant.Companion.localAdvanced470Path
import com.blobcity.Constant.Companion.localAdvanced471Path
import com.blobcity.Constant.Companion.localAdvanced475Path
import com.blobcity.Constant.Companion.localAdvanced476Path
import com.blobcity.Constant.Companion.localAdvanced482Path
import com.blobcity.Constant.Companion.localAdvanced483Path
import com.blobcity.Constant.Companion.localAdvanced487Path
import com.blobcity.Constant.Companion.localAdvanced488Path
import com.blobcity.Constant.Companion.localAdvanced494Path
...
import com.blobcity.Constant.Companion.localBasic430Path
import com.blobcity.Constant.Companion.localBasic431Path
import com.blobcity.Constant.Companion.localBasic432Path
import com.blobcity.Constant.Companion.localBasic433Path
import com.blobcity.Constant.Companion.localBasic442Path
import com.blobcity.Constant.Companion.localBasic443Path
import com.blobcity.Constant.Companion.localBasic444Path
import com.blobcity.Constant.Companion.localBasic445Path
import com.blobcity.Constant.Companion.localBasic454Path
import com.blobcity.Constant.Companion.localBasic455Path
import com.blobcity.Constant.Companion.localBasic456Path
import com.blobcity.Constant.Companion.localBasic457Path
import com.blobcity.Constant.Companion.localBasic466Path
import com.blobcity.Constant.Companion.localBasic467Path
import com.blobcity.Constant.Companion.localBasic468Path
import com.blobcity.Constant.Companion.localBasic469Path
import com.blobcity.Constant.Companion.localBasic478Path
import com.blobcity.Constant.Companion.localBasic479Path
import com.blobcity.Constant.Companion.localBasic480Path
import com.blobcity.Constant.Companion.localBasic481Path
import com.blobcity.Constant.Companion.localBasic490Path
...
import com.blobcity.Constant.Companion.localIntermediate436Path
import com.blobcity.Constant.Companion.localIntermediate437Path
import com.blobcity.Constant.Companion.localIntermediate438Path
import com.blobcity.Constant.Companion.localIntermediate441Path
import com.blobcity.Constant.Companion.localIntermediate448Path
import com.blobcity.Constant.Companion.localIntermediate449Path
import com.blobcity.Constant.Companion.localIntermediate450Path
import com.blobcity.Constant.Companion.localIntermediate453Path
import com.blobcity.Constant.Companion.localIntermediate460Path
import com.blobcity.Constant.Companion.localIntermediate461Path
import com.blobcity.Constant.Companion.localIntermediate462Path
import com.blobcity.Constant.Companion.localIntermediate465Path
import com.blobcity.Constant.Companion.localIntermediate472Path
import com.blobcity.Constant.Companion.localIntermediate473Path
import com.blobcity.Constant.Companion.localIntermediate474Path
import com.blobcity.Constant.Companion.localIntermediate477Path
import com.blobcity.Constant.Companion.localIntermediate484Path
import com.blobcity.Constant.Companion.localIntermediate485Path
import com.blobcity.Constant.Companion.localIntermediate486Path
import com.blobcity.Constant.Companion.localIntermediate489Path
import com.blobcity.Constant.Companion.localIntermediate496Path
...
import com.blobcity.Constant.Companion.localTopicEightPath
import com.blobcity.Constant.Companion.localTopicFivePath
import com.blobcity.Constant.Companion.localTopicFourPath
import com.blobcity.Constant.Companion.localTopicNinePath
